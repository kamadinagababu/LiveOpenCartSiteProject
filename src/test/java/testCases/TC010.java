...
public class TC010 {
	...
	public void verifyRegisterAccountWithSymbleAndColor() {
		...
		String ExpectedColor="rgb(255, 0, 0)";
		 ...
		 String fnContent = (String) js.executeScript("return window.getComputedStyle(arguments[0], '::before').getPropertyValue('content');",
	                FirstNameLabel);
		 ...
		 String lnContent = (String) js1.executeScript("return window.getComputedStyle(arguments[0], '::before').getPropertyValue('content');",
				 LastNameLabel);
		 ...
		 String EmailContent = (String) js2.executeScript("return window.getComputedStyle(arguments[0], '::before').getPropertyValue('content');",
				 EmailLabel);
		 ...
		 String TelephoneContent = (String) js3.executeScript("return window.getComputedStyle(arguments[0], '::before').getPropertyValue('content');",
				 TelephoneLabel);
		 ...
		 String pwdContent = (String) js4.executeScript("return window.getComputedStyle(arguments[0], '::before').getPropertyValue('content');",
				 PasswordLabel);
		 ...
		 String confirmpwdContent = (String) js5.executeScript("return window.getComputedStyle(arguments[0], '::before').getPropertyValue('content');",
