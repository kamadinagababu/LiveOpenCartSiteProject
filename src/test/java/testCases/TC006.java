...
public class TC006 {
	...
	public void verifyAcoountRigisterWithInavlidEmail() throws IOException, InterruptedException
	{
     ...
     //take screenshot1
      File srcScreenshot1=driver.findElement(By.xpath("//fieldset[@id='account']")).getScreenshotAs(OutputType.FILE);
    ...
    Assert.assertEquals(driver.findElement(By.xpath("//div[contains(text(),'E-Mail Address does not appear to be valid!')]")).getText(), expectedWarningMsgMail);
   ...
   // driver.findElement(By.xpath("//input[@id='input-email']")).clear();
    ...
    Thread.sleep(3000);
     ...
     File srcScreenshot3=driver.findElement(By.xpath("//fieldset[@id='account']")).getScreenshotAs(OutputType.FILE);
